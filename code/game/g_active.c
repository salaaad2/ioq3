...
void ClientTimerActions( gentity_t *ent, int msec ) {
	...
	if( bg_itemlist[client->ps.stats[STAT_PERSISTANT_POWERUP]].giTag == PW_AMMOREGEN ) {
		int w, max, inc, t, i;
    int weapList[]={WP_MACHINEGUN,WP_SHOTGUN,WP_GRENADE_LAUNCHER,WP_ROCKET_LAUNCHER,WP_LIGHTNING,WP_RAILGUN,WP_PLASMAGUN,WP_BFG,WP_NAILGUN,WP_PROX_LAUNCHER,WP_CHAINGUN,WP_TPHAND};
    ...
    for (i = 0; i < weapCount; i++) {
		  ...
		  switch(w) {
			  ...
			  case WP_TPHAND: max = 50; inc = 4; t = 1000; break;
